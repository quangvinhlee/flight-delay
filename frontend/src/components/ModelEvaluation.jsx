                ...
                <table className="table-auto border-collapse border border-gray-400 mb-4 text-xs md:text-sm w-full max-w-4xl mx-auto">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td className="border border-gray-300">{roundToThreeDecimals(evaluationData.classification_report["0"].precision)}</td>
                            <td className="border border-gray-300">{roundToThreeDecimals(evaluationData.classification_report["1"].precision)}</td>
                        </tr>
                        <tr>
                            <td className="border border-gray-300">Recall</td>
                            <td className="border border-gray-300">{roundToThreeDecimals(evaluationData.classification_report["0"].recall)}</td>
                            <td className="border border-gray-300">{roundToThreeDecimals(evaluationData.classification_report["1"].recall)}</td>
                        </tr>
                        <tr>
                            <td className="border border-gray-300">F1 Score</td>
                            <td className="border border-gray-300">{roundToThreeDecimals(evaluationData.classification_report["0"]["f1-score"])}</td>
                            <td className="border border-gray-300">{roundToThreeDecimals(evaluationData.classification_report["1"]["f1-score"])}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td className="border border-gray-300" colSpan="2">{roundToThreeDecimals(evaluationData.classification_report.accuracy)}</td>
                        </tr>
                        <tr>
                            <td className="border border-gray-300">Macro Avg Precision</td>
                            <td className="border border-gray-300" colSpan="2">{roundToThreeDecimals(evaluationData.classification_report["macro avg"].precision)}</td>
                        </tr>
                        <tr>
                            <td className="border border-gray-300">Macro Avg Recall</td>
                            <td className="border border-gray-300" colSpan="2">{roundToThreeDecimals(evaluationData.classification_report["macro avg"].recall)}</td>
                        </tr>
                        <tr>
                            <td className="border border-gray-300">Macro Avg F1 Score</td>
                            <td className="border border-gray-300" colSpan="2">{roundToThreeDecimals(evaluationData.classification_report["macro avg"]["f1-score"])}</td>
                        </tr>
                        <tr>
                            <td className="border border-gray-300">Weighted Avg Precision</td>
                            <td className="border border-gray-300" colSpan="2">{roundToThreeDecimals(evaluationData.classification_report["weighted avg"].precision)}</td>
                        </tr>
                        <tr>
                            <td className="border border-gray-300">Weighted Avg Recall</td>
                            <td className="border border-gray-300" colSpan="2">{roundToThreeDecimals(evaluationData.classification_report["weighted avg"].recall)}</td>
                        </tr>
                        <tr>
                            <td className="border border-gray-300">Weighted Avg F1 Score</td>
                            <td className="border border-gray-300" colSpan="2">{roundToThreeDecimals(evaluationData.classification_report["weighted avg"]["f1-score"])}</td>
                        </tr>
                    </tbody>
                </table>
            </div>
